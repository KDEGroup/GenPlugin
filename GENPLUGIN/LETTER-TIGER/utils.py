...
def load_datasets(args):
    ...
    valid_data = SeqRecDataset(args,"valid",args.data_mode,args.valid_prompt_sample_num)
...
def load_test_dataset(args):
    ...
    if args.test_task.lower() == "seqrec":
        ...
        test_data = SeqRecDataset(args, mode="test", data_mode=args.data_mode, sample_num=args.sample_num)
    else:
        raise NotImplementedError
