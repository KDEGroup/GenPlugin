...
def parse_args():
    ...
    parser.add_argument("--data_path", type=str, default="/path/to/your/LC-Rec_images", help="Input data path.")
    parser.add_argument("--dataset", type=str, default="Instruments", help="Input data path.")
    
    parser.add_argument("--output_dir", type=str, default="/path/to/your/TIGER_image/log/encoder-decoder/Instruments/ckpt_b256_lr0.0005_wd0.01_dm0_e200_index_lemb_256_dis_seqrec,seqimage,item2image,image2item,fusionseqrec", help="Input data path.")
