...
class final_model(nn.Module):
    ...
    def __init__(self, T5config, args):
        ...
        self.text_emb = np.load(f'../data/{dataset}/{dataset}.emb-two-llama2-td.npy')
        self.image_emb = np.load(f'../data/{dataset}/{dataset}.emb-ViT-L-14.npy')
        ...
        self.image_emb = torch.tensor(self.image_emb, dtype=torch.float32)
